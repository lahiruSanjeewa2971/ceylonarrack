        ...
        <div className='tasting-container'>
            ...
            >
                <div className="first-section">
                    <div id='first-section-title' className="first-section-title">
                        <h2>The original base spirit for punch</h2>
                    </div>
                    <div id='first-section-paragraph' className="first-section-paragraph">
                    ...
                    <div id='first-section-image' className="first-secion-image">
